...
function SelectChangeHandler()
{
	...
	//alert(pathVar);
		...
		if( imgString.indexOf('commonfiles') >= 1 )
		{
			...
			var folderURL ='http://expressmedalscom.ipage.com/product_designers/commonfiles'+pathVar+"/";
		} else if (imgString.indexOf(productCode) >= 1 )
		{
			...
			//alert(folderArry);
			var folderURL ='http://expressmedalscom.ipage.com/product_designers/'+productCode+''+pathVar+'/';
		}
